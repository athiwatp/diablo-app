...
class HomeController extends Controller
{
    ...
    public function data() : string
    {
        ...
        $data->put(
            'softcore_show_all', '/leaderboards/filter/paginate?season=1&period='.env('CURRENT_SEASON').'&hardcore=0&players=1'
        );
        $data->put(
            'hardcore_show_all', '/leaderboards/filter/paginate?season=1&period='.env('CURRENT_SEASON').'&hardcore=1&players=1'
        );
